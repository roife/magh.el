...
(defconst magh-embark--category-maps
  '((magh-repository . magh-embark-repository-map)
    ...
    (magh-artifact . magh-embark-resource-map)
    (magh-project . magh-embark-resource-map)
    (magh-project-item . magh-embark-resource-map)
    (magh-project-field . magh-embark-resource-map)
    (magh-discussion . magh-embark-resource-map)
    (magh-discussion-comment . magh-embark-resource-map)
    (magh-gist . magh-embark-resource-map)
    (magh-gist-file . magh-embark-resource-map)
